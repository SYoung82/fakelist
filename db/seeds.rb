...
User.create(username: "Scott", email: "scott@email.com", password: "password", is_admin: true)
User.create(username: "Sean", email: "sean@email.com", password: "password", :is_admin => false)
User.create(username: "Layne", email: "layne@email.com", password: "password", :is_admin => false)
User.create(username: "Kristen", email: "kristen@email.com", password: "password", :is_admin => false)
User.create(username: "Bozo", email: "bozo@email.com", password: "password", :is_admin => false)
